            ...
            <div class="max-w-[1065px] mx-auto">
                ...
                <div class="bg-white shadow lg:rounded-b-2xl lg:-mt-10 dark:bg-dark2">
                    ...
                    <div class="relative overflow-hidden w-full lg:h-60 h-40">
                        <img src="./socialminds/assets/images/group/group-cover-4.jpg" alt="" class="h-full w-full object-cover inset-0">
                        ...
                        <div class="flex flex-col justify-center -mt-20">
                            ...
                            <div class="relative h-20 w-20 mb-4 z-10">
                                <div class="relative overflow-hidden rounded-full md:border-[2px] border-gray-100 shrink-0 dark:border-slate-900 shadow">
                                    <img src="./socialminds/assets/images/avatars/avatar-6.jpg" alt="" class="h-full w-full object-cover inset-0">                           
                                </div>
                            </div>
                            ...
                            <div class="box p-5 px-6">
                                ...
                                <div class="side-list">
                                    ...
                                    <div class="side-list-item">
                                        ...
                                        <div class="flex-1">
                                            <a href="timeline-page.php"><h4 class="side-list-title"> Monroe Parker  </h4></a>
                                    ...
                                    <div class="side-list-item">
                                        ...
                                        <div class="flex-1">
                                            <a href="timeline-page.php"><h4 class="side-list-title"> John Michael  </h4></a>
                                            <div class="side-list-info"> 320k Following   </div>
                                        </div>
                                        <button class="button bg-secondery">edit</button>
                                    </div>
                            ...
                            <div class="box p-5 px-6">
                                ...
                                <div class="side-list">
                                    ...
                                    <div class="side-list-item">
                                        ...
                                        <div class="flex-1">
                                            <a href="timeline-page.php"><h4 class="side-list-title"> James Lewis  </h4></a>
