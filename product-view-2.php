                    ...
                    <div class="max-w-[1220px] mx-auto flex items-center">
                        ...
                        <div class="flex items-center sm:gap-4 gap-2 absolute right-5 top-1/2 -translate-y-1/2 text-black">
                            ...
                            <div    class="hidden bg-white p-4 rounded-lg overflow-hidden drop-shadow-xl dark:bg-slate-700 md:w-[324px] w-screen border2"
                                    ...
                                    <ul class="-m-1 mt-4 pb-1 text-xs text-gray-500 dark:text-white" uk-scrollspy="target: > li; cls: uk-animation-scale-up , uk-animation-slide-bottom-small ;repeat: true">
                                        <li class="flex items-center gap-4 hover:bg-secondery rounded-md p-1.5 cursor-pointer dark:hover:bg-white/10">
                                            <img src="./socialminds/assets/images/icons/group.png" alt="" class="w-7">
                                            <div class="flex-1">
                                                <a href="timeline.php"><h4 class="font-medium text-sm text-black dark:text-white"> Groups </h4></a>
                                                <div class="mt-1 text-xs text-gray-500 dark:text-white"> Meet people with similar interests. </div>
                                            </div>
                                        </li>
                                        <li class="flex items-center gap-4 hover:bg-secondery rounded-md p-1.5 cursor-pointer dark:hover:bg-white/10">
                                            <img src="./socialminds/assets/images/icons/page.png" alt="" class="w-7">
                                            <div class="flex-1">
                                                <a href="timeline.php"><h4 class="font-medium text-sm text-black dark:text-white"> Pages </h4></a>
                                                <div class="mt-1"> Find and connect with businesses.
                                            </div>
                                        </li>
                                        <li class="flex items-center gap-4 hover:bg-secondery rounded-md p-1.5 cursor-pointer dark:hover:bg-white/10">
                                            <img src="./socialminds/assets/images/icons/event.png" class="w-7">
                                            <div class="flex-1">
                                                <a href="timeline.php"><h4 class="font-medium text-sm text-black dark:text-white"> Event </h4></a>
                                                <div class="mt-1">Discover fun activities near you .</div>
                                            </div>
                                        </li>
                                        <li class="flex items-center gap-4 hover:bg-secondery rounded-md p-1.5 cursor-pointer dark:hover:bg-white/10">
                                            <img src="./socialminds/assets/images/icons/market.png" class="w-8 -ml-1">
                                            <div class="flex-1">
                                                <a href="timeline.php"><h4 class="font-medium text-sm text-black dark:text-white"> Event </h4></a>
                                        ...
                                        <li class="flex items-center gap-4 hover:bg-secondery rounded-md p-1.5 cursor-pointer dark:hover:bg-white/10">
                                            <img src="./socialminds/assets/images/icons/game.png" alt="" class="w-7">
                                            <div class="flex-1">
                                                <a href="timeline.php"><h4 class="font-medium text-sm text-black dark:text-white"> Games </h4></a>
                                    ...
                                    <div class="p-2 pt-0 pr-1 dark:text-white/80">
                                        ...
                                        <a href="#" class="relative flex items-center gap-4 p-2 py-3 duration-200 rounded-lg hover:bg-secondery dark:hover:bg-white/10">
                                            <div class="relative w-10 h-10 shrink-0"> 
                                                <img src="./socialminds/assets/images/avatars/avatar-2.jpg" alt="" class="object-cover w-full h-full rounded-full">
                                            </div>
                                        ...
                                        <a href="#" class="relative flex items-center gap-4 p-2 py-3 duration-200 rounded-lg hover:bg-secondery dark:hover:bg-white/10">
                                            <div class="relative w-10 h-10 shrink-0"> 
                                                <img src="./socialminds/assets/images/avatars/avatar-4.jpg" alt="" class="object-cover w-full h-full rounded-full">
                                            </div>
                                            <div class="flex-1 min-w-0">
                                                <div class="flex items-center gap-2 mb-1">
                                        ...
                                        <a href="#" class="relative flex items-center gap-4 p-2 py-3 duration-200 rounded-lg hover:bg-secondery dark:hover:bg-white/10">
                                            <div class="relative w-10 h-10 shrink-0"> 
                                                <img src="./socialminds/assets/images/avatars/avatar-5.jpg" alt="" class="object-cover w-full h-full rounded-full">
                                            </div>
                                            <div class="flex-1 min-w-0">
                                                <div class="flex items-center gap-2 mb-1">
                                                    <div class="mr-auto text-sm text-black dark:text-white font-medium">Jesse Steeve</div>
                                        ...
                                        <a href="#" class="relative flex items-center gap-4 p-2 py-3 duration-200 rounded-lg hover:bg-secondery dark:hover:bg-white/10">
                                            <div class="relative w-10 h-10 shrink-0"> 
                                                <img src="./socialminds/assets/images/avatars/avatar-3.jpg" alt="" class="object-cover w-full h-full rounded-full">
                                            </div>
                                            <div class="flex-1 min-w-0">
                                                <div class="flex items-center gap-2 mb-1">
                                        ...
                                        <a href="#" class="relative flex items-center gap-4 p-2 py-3 duration-200 rounded-lg hover:bg-secondery dark:hover:bg-white/10">
                                            <div class="relative w-10 h-10 shrink-0"> 
                                                <img src="./socialminds/assets/images/avatars/avatar-7.jpg" alt="" class="object-cover w-full h-full rounded-full">
                                            </div>
                                            <div class="flex-1 min-w-0">
                                                <div class="flex items-center gap-2 mb-1">
                            ...
                            <div  class="rounded-full relative bg-secondery cursor-pointer shrink-0">
                                <img src="./socialminds/assets/images/avatars/avatar-2.jpg" alt="" class="sm:w-9 sm:h-9 w-7 h-7 rounded-full shadow shrink-0"> 
                            </div>
                            <div  class="hidden bg-white rounded-lg drop-shadow-xl dark:bg-slate-700 w-64 border2"
                                ...
                                <a href="timeline.php">
                                    <div class="p-4 py-5 flex items-center gap-4">
                                        <img src="./socialminds/assets/images/avatars/avatar-2.jpg" alt="" class="w-10 h-10 rounded-full shadow">
                                        <div class="flex-1">
                ...
                <div class="pr-4" data-simplebar>
                    ...
                    <nav id="side">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="pages.php">
                                    <img src="./socialminds/assets/images/icons/page.png" alt="pages" class="w-6">
                                    <span> Pages </span> 
                                </a>
                            </li>
                            <li>
                    ...
                    <div class="font-medium text-sm text-black border-t pt-3 mt-2 dark:text-white dark:border-slate-800">
                        ...
                        <a href="#">
                            <div class="flex items-center gap-2 p-3 px-4 rounded-xl hover:bg-secondery">
                                <img src="./socialminds/assets/images/avatars/avatar-2.jpg" alt="" class="w-6 rounded-full object-cover">
                                <div> Marin Gray</div>
                            </div>
                        </a>
                        <a href="#">
                            <div class="flex items-center gap-2 p-3 px-4 rounded-xl hover:bg-secondery">
                                <img src="./socialminds/assets/images/avatars/avatar-7.jpg" alt="" class="w-6 rounded-full object-cover">
                                <div>   Alexa Stella</div>
                            </div>
                        </a>
                        <a href="#">
                            <div class="flex items-center gap-2 p-3 px-4 rounded-xl hover:bg-secondery">
                                <img src="./socialminds/assets/images/avatars/avatar-3.jpg" alt="" class="w-6 rounded-full object-cover">
                                <div> Sarah Ali</div>
                            </div>
                        </a> 
                    </div>
                    ...
                    <div class="rounded-lg box">
                        ...
                        <div class="relative" uk-slideshow="animation: push; ratio: 7:5">
                            ...
                            <ul class="uk-slideshow-items overflow-hidden rounded-t-xl" uk-lightbox="animation: fade"> 
                                <li class="w-full">
                                    <a class="inline" href="assets/images/product/product-1.jpg" data-caption="Caption 1"> 
                                        <img src="./socialminds/assets/images/product/product-1.jpg" alt="" class="w-full h-full absolute object-cover insta-0">
                                    </a>
                                </li>
                                <li class="w-full">
                                    <a class="inline" href="assets/images/product/product-5.jpg" data-caption="Caption 2"> 
                                        <img src="./socialminds/assets/images/product/product-5.jpg" alt="" class="w-full h-full absolute object-cover insta-0">
                                    </a>
                                </li>
                                <li class="w-full">
                                    <a class="inline" href="assets/images/product/product-10.jpg" data-caption="Caption 3"> 
                                        <img src="./socialminds/assets/images/product/product-10.jpg" alt="" class="w-full h-full absolute object-cover insta-0">
                                    </a>
                                </li> 
                            </ul>
                            ...
                            <ul class="flex justify-center gap-4 py-4 absolute w-full bottom-0">
                                <li uk-slideshow-item="0"><a href="#"> <img src="assets/images/product/product-1.jpg" alt="" class="w-16 h-12 rounded"> </a></li>
                                <li uk-slideshow-item="1"><a href="#"> <img src="assets/images/product/product-5.jpg" alt="" class="w-16 h-12 rounded"></a></li>
                                <li uk-slideshow-item="2"><a href="#"> <img src="assets/images/product/product-10.jpg" alt="" class="w-16 h-12 rounded"></a></li>
                            </ul>
                        ...
                        <div class="md:space-y-5 space-y-3 p-5">
                            ...
                            <div class="flex justify-between md:pr-4">
                                ...
                                <h1 class="text-xl font-semibold"> ₹1300 </h1>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex gap-3 py-2 text-sm font-medium mt-2">
                                    <a href="timeline.php"> <img src="./socialminds/assets/images/avatars/avatar-3.jpg" alt="" class="w-9 h-9 rounded-full"> </a>  
                                    <div class="flex-1">
                                        <a href="timeline.php"> <h4 class="text-black dark:text-white"> Monroe Parker </h4> </a>  
                            ...
                            <ul class="uk-slider-items w-[calc(100%+10px)]" uk-scrollspy="target: > li; cls: uk-animation-scale-up; delay: 20;repeat:true">
                                ...
                                <li class="sm:w-1/3 w-1/2 pr-3">
                                    <div class="card uk-transition-toggle">
                                        <a href="product-view-1.php">
                                            <div class="card-media sm:aspect-[2/1.7] h-36">
                                                <img src="./socialminds/assets/images/product/product-10.jpg" alt="">
                                                <div class="card-overly"></div> 
                                            </div> 
                                        </a>
                                        <div class="card-body flex justify-between">
                                            <div class="flex-1">
                                                <a href="product-view-1.php"><p class="card-text text-black font-medium line-clamp-1"> Herbal </p> </a>
                                ...
                                <li class="sm:w-1/3 w-1/2 pr-3">
                                    <div class="card uk-transition-toggle">
                                        <a href="product-view-1.php">
                                            <div class="card-media sm:aspect-[2/1.7] h-36">
                                                <img src="./socialminds/assets/images/product/product-9.jpg" alt="">
                                                <div class="card-overly"></div> 
                                            </div> 
                                        </a>
                                        <div class="card-body flex justify-between">
                                            <div class="flex-1">
                                                <a href="product-view-1.php"><p class="card-text text-black font-medium line-clamp-1"> Furniture </p> </a>
                                ...
                                <li class="sm:w-1/3 w-1/2 pr-3">
                                    <div class="card uk-transition-toggle">
                                        <a href="product-view-1.php">
                                            <div class="card-media sm:aspect-[2/1.7] h-36">
                                                <img src="./socialminds/assets/images/product/product-3.jpg" alt="">
                                                <div class="card-overly"></div> 
                                            </div> 
                                        </a>
                                        <div class="card-body flex justify-between">
                                            <div class="flex-1">
                                                <a href="product-view-1.php"><p class="card-text text-black font-medium line-clamp-1"> Electronic </p> </a>
                                ...
                                <li class="sm:w-1/3 w-1/2 pr-3">
                                    <div class="card uk-transition-toggle">
                                        <a href="product-view-1.php">
                                            <div class="card-media sm:aspect-[2/1.7] h-36">
                                                <img src="./socialminds/assets/images/product/product-1.jpg" alt="">
                                                <div class="card-overly"></div> 
                                            </div> 
                                        </a>
                                        <div class="card-body flex justify-between">
                                            <div class="flex-1">
                                                <a href="product-view-1.php"><p class="card-text text-black font-medium line-clamp-1"> Shampo </p> </a>
                    ...
                    <div class="box p-5 px-6">
                        ...
                        <div class="side-list">
                            ...
                            <div class="side-list-item">
                                <a href="timeline.php">
                                    <img src="./socialminds/assets/images/avatars/avatar-2.jpg" alt="" class="side-list-image rounded-full">
                                </a>
                                <div class="flex-1">
                                    <a href="timeline.php"><h4 class="side-list-title">  John Michael </h4></a>
                            ...
                            <div class="side-list-item">
                                <a href="timeline.php">
                                    <img src="./socialminds/assets/images/avatars/avatar-3.jpg" alt="" class="side-list-image rounded-full">
                                </a>
                                <div class="flex-1">
                                    <a href="timeline.php"><h4 class="side-list-title"> Monroe Parker </h4></a>
                            ...
                            <div class="side-list-item">
                                <a href="timeline.php">
                                    <img src="./socialminds/assets/images/avatars/avatar-5.jpg" alt="" class="side-list-image rounded-full">
                                </a>
                                <div class="flex-1">
                                    <a href="timeline.php"><h4 class="side-list-title"> James Lewis</h4></a>
                                    <div class="side-list-info"> 125k Following </div>
                                </div>
                                <button class="button bg-primary-soft text-primary dark:text-white">follow</button>
                            </div>
                            ...
                            <div class="side-list-item">
                                <a href="timeline.php">
                                    <img src="./socialminds/assets/images/avatars/avatar-6.jpg" alt="" class="side-list-image rounded-full">
                                </a>
                                <div class="flex-1">
                                    <a href="timeline.php"><h4 class="side-list-title">  Alexa stella </h4></a>
                    ...
                    <div class="box p-5 px-6 border1 dark:bg-dark2 hidden">
                        ...
                        <div class="space-y-4 capitalize text-xs font-normal mt-5 mb-2 text-gray-500 dark:text-white/80">
                            ...
                            <div class="flex items-center gap-3">
                                <a href="timeline.php">
                                    <img src="./socialminds/assets/images/avatars/avatar-7.jpg" alt="" class="bg-gray-200 rounded-full w-10 h-10">
                                </a>
                                <div class="flex-1">
                                    <a href="timeline.php"><h4 class="font-semibold text-sm text-black dark:text-white">  Johnson smith</h4></a>
                            ...
                            <div class="flex items-center gap-3">
                                <a href="timeline.php">
                                    <img src="./socialminds/assets/images/avatars/avatar-5.jpg" alt="" class="bg-gray-200 rounded-full w-10 h-10">
                                </a>
                                <div class="flex-1">
                                    <a href="timeline.php"><h4 class="font-semibold text-sm text-black dark:text-white"> James Lewis</h4></a>
                            ...
                            <div class="flex items-center gap-3">
                                <a href="timeline.php">
                                    <img src="./socialminds/assets/images/avatars/avatar-2.jpg" alt="" class="bg-gray-200 rounded-full w-10 h-10">
                                </a>
                                <div class="flex-1">
                                    <a href="timeline.php"><h4 class="font-semibold text-sm text-black dark:text-white"> John Michael</h4></a>
                            ...
                            <div class="flex items-center gap-3">
                                <a href="timeline.php">
                                    <img src="./socialminds/assets/images/avatars/avatar-3.jpg" alt="" class="bg-gray-200 rounded-full w-10 h-10">
                                </a>
                                <div class="flex-1">
                                    <a href="timeline.php"><h4 class="font-semibold text-sm text-black dark:text-white">  Monroe Parker</h4></a>
                                    <div class="mt-0.5"> Suggested For You </div>
                                </div>
                                <button type="button" class="text-sm rounded-full py-1.5 px-4 font-semibold bg-secondery"> Follow </button>
                            </div> 
                            <div class="flex items-center gap-3">
                                <a href="timeline.php">
                                    <img src="./socialminds/assets/images/avatars/avatar-4.jpg" alt="" class="bg-gray-200 rounded-full w-10 h-10">
                                </a>
                                <div class="flex-1">
                                    <a href="timeline.php"><h4 class="font-semibold text-sm text-black dark:text-white">  Martin Gray</h4></a>
                                    <div class="mt-0.5"> Suggested For You </div>
                                </div>
                                <button type="button" class="text-sm rounded-full py-1.5 px-4 font-semibold bg-secondery"> Follow </button>
                            </div>
                                ...
                                <ul class="-ml-2 uk-slider-items w-[calc(100%+0.5rem)]">
                                         ...
                                         <a href="#">
                                            <div class="relative overflow-hidden rounded-lg">
                                                <div class="relative w-full h-40">
                                                    <img src="./socialminds/assets/images/product/product-1.jpg" alt="" class="object-cover w-full h-full inset-0">
                                                </div> 
                                                <div class="absolute right-0 top-0 m-2 bg-white/60 rounded-full py-0.5 px-2 text-sm font-semibold dark:bg-slate-800/60"> ₹1200 </div>
                                            </div>
                                    ...
                                    <li class="w-1/2 pr-2">
                                         ...
                                         <a href="#">
                                            <div class="relative overflow-hidden rounded-lg">
                                                <div class="relative w-full h-40">
                                                    <img src="./socialminds/assets/images/product/product-3.jpg" alt="" class="object-cover w-full h-full inset-0">
                                                </div> 
                                                <div class="absolute right-0 top-0 m-2 bg-white/60 rounded-full py-0.5 px-2 text-sm font-semibold dark:bg-slate-800/60"> ₹1800 </div>
                                            </div>
                                    ...
                                    <li class="w-1/2 pr-2">
                                        ...
                                        <a href="#">
                                            <div class="relative overflow-hidden rounded-lg">
                                                <div class="relative w-full h-40">
                                                    <img src="./socialminds/assets/images/product/product-5.jpg" alt="" class="object-cover w-full h-full inset-0">
                                                </div> 
                                                <div class="absolute right-0 top-0 m-2 bg-white/60 rounded-full py-0.5 px-2 text-sm font-semibold dark:bg-slate-800/60"> ₹1200 </div>
                                            </div>
                        ...
                        <div class="grid grid-cols-6 gap-3 mt-4">
                            ...
                            <a href="timeline.php"> 
                                <div class="w-10 h-10 relative">
                                    <img src="./socialminds/assets/images/avatars/avatar-2.jpg" alt="" class="w-full h-full absolute inset-0 rounded-full">
                                    <div class="absolute bottom-0 right-0 m-0.5 bg-green-500 rounded-full w-2 h-2"></div>
                                </div> 
                            </a>
                            <a href="timeline.php"> 
                                <div class="w-10 h-10 relative">
                                    <img src="./socialminds/assets/images/avatars/avatar-3.jpg" alt="" class="w-full h-full absolute inset-0 rounded-full">
                                    <div class="absolute bottom-0 right-0 m-0.5 bg-green-500 rounded-full w-2 h-2"></div>
                                </div>
                            </a>
                            <a href="timeline.php">  
                                <div class="w-10 h-10 relative">
                                    <img src="./socialminds/assets/images/avatars/avatar-4.jpg" alt="" class="w-full h-full absolute inset-0 rounded-full">
                                    <div class="absolute bottom-0 right-0 m-0.5 bg-green-500 rounded-full w-2 h-2"></div>
                                </div> 
                            </a>
                            <a href="timeline.php"> 
                                <div class="w-10 h-10 relative">
                                    <img src="./socialminds/assets/images/avatars/avatar-5.jpg" alt="" class="w-full h-full absolute inset-0 rounded-full">
                                    <div class="absolute bottom-0 right-0 m-0.5 bg-green-500 rounded-full w-2 h-2"></div>
                                </div> 
                            </a>
                            <a href="timeline.php"> 
                                <div class="w-10 h-10 relative">
                                    <img src="./socialminds/assets/images/avatars/avatar-6.jpg" alt="" class="w-full h-full absolute inset-0 rounded-full">
                                    <div class="absolute bottom-0 right-0 m-0.5 bg-green-500 rounded-full w-2 h-2"></div>
                                </div> 
                            </a>
                            <a href="timeline.php"> 
                                <div class="w-10 h-10 relative">
                                    <img src="./socialminds/assets/images/avatars/avatar-7.jpg" alt="" class="w-full h-full absolute inset-0 rounded-full">
                                    <div class="absolute bottom-0 right-0 m-0.5 bg-green-500 rounded-full w-2 h-2"></div>
                                </div> 
                            </a>
                                ...
                                <ul class="-ml-2 uk-slider-items w-[calc(100%+0.5rem)]">
                                        ...
                                        <div class="flex flex-col items-center shadow-sm p-2 rounded-xl border1">
                                            <a href="timeline.php"> 
                                                <div class="relative w-16 h-16 mx-auto mt-2">
                                                    <img src="./socialminds/assets/images/avatars/avatar-5.jpg" alt="" class="h-full object-cover rounded-full shadow w-full">
                                                </div>
                                            </a>
                                            <div class="mt-5 text-center w-full">
                                                <a href="timeline.php"> <h5 class="font-semibold"> Martin Gray</h5> </a>
                                    ...
                                    <li class="w-1/2 pr-2">
                                        <div class="flex flex-col items-center shadow-sm p-2 rounded-xl border1">
                                            <a href="timeline.php"> 
                                                <div class="relative w-16 h-16 mx-auto mt-2">
                                                    <img src="./socialminds/assets/images/avatars/avatar-4.jpg" alt="" class="h-full object-cover rounded-full shadow w-full">
                                                </div>
                                            </a> 
                                            <div class="mt-5 text-center w-full">
                                                <a href="timeline.php"> <h5 class="font-semibold"> Alexa Park</h5> </a>
                                                <div class="text-xs text-gray-400 mt-0.5 font-medium"> 12K Followers</div>
                                                <button type="button" class="bg-secondery block font-semibold mt-4 py-1.5 rounded-lg text-sm w-full border1"> Follow </button>
                                            </div>
                                        </div>
                                    ...
                                    <li class="w-1/2 pr-2">
                                        <div class="flex flex-col items-center shadow-sm p-2 rounded-xl border1">
                                            ...
                                            <div class="mt-5 text-center w-full">
                                                <a href="timeline.php"> <h5 class="font-semibold"> James Lewis</h5> </a>
                    ...
                    <div class="space-y -m t-5 p-3 text-sm font-medium h-[280px] overflow-y-auto">
                        ...
                        <a href="#" class="block">
                            <div class="flex items-center gap-3.5 rounded-lg p-2 hover:bg-secondery dark:hover:bg-white/10">
                                <img src="./socialminds/assets/images/avatars/avatar-1.jpg" alt="" class="w-7 rounded-full">
                                <div> Jesse Steeve </div>
                            </div>
                        </a>
                        <a href="#" class="block">
                            <div class="flex items-center gap-3.5 rounded-lg p-2 hover:bg-secondery dark:hover:bg-white/10">
                                <img src="./socialminds/assets/images/avatars/avatar-2.jpg" alt="" class="w-7 rounded-full">
                                <div> John Michael </div>
                            </div>
                        </a>
                        <a href="#" class="block">
                            <div class="flex items-center gap-3.5 rounded-lg p-2 hover:bg-secondery dark:hover:bg-white/10">
                                <img src="./socialminds/assets/images/avatars/avatar-3.jpg" alt="" class="w-7 rounded-full">
                                <div> Monroe Parker </div>
                            </div>
                        </a>
                        <a href="#" class="block">
                            <div class="flex items-center gap-3.5 rounded-lg p-2 hover:bg-secondery dark:hover:bg-white/10">
                                <img src="./socialminds/assets/images/avatars/avatar-5.jpg" alt="" class="w-7 rounded-full">
                                <div> James Lewis </div>
                            </div>
                        </a> 
                        <a href="#" class="block">
                            <div class="flex items-center gap-3.5 rounded-lg p-2 hover:bg-secondery dark:hover:bg-white/10">
                                <img src="./socialminds/assets/images/avatars/avatar-4.jpg" alt="" class="w-7 rounded-full">
                                <div> Martin Gray </div>
                            </div>
                        </a>
                        <a href="#" class="block">
                            <div class="flex items-center gap-3.5 rounded-lg p-2 hover:bg-secondery dark:hover:bg-white/10">
                                <img src="./socialminds/assets/images/avatars/avatar-6.jpg" alt="" class="w-7 rounded-full">
                                <div> Alexa stella </div>
                            </div>
                        </a>
                        <a href="#" class="block">
