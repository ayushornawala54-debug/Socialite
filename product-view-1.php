                    ...
                    <div class="lg:max-w-[680px] w-full">
                        ...
                        <div class="relative" uk-slideshow="animation: push; ratio: 7:5">
                            ...
                            <ul class="uk-slideshow-items overflow-hidden rounded-xl" uk-lightbox="animation: fade"> 
                                ...
                                <li class="w-full">
                                    <a class="inline" href="./socialminds/assets/images/product/product-5.jpg" data-caption="Caption 2"> 
                                        <img src="./socialminds/assets/images/product/product-5.jpg" alt="" class="w-full h-full absolute object-cover insta-0">
                                    </a>
                                </li>
                                <li class="w-full">
                                    <a class="inline" href="./socialminds/assets/images/product/product-10.jpg" data-caption="Caption 3"> 
                            ...
                            <ul class="flex justify-center gap-4 py-4 absolute w-full bottom-0">
                                <li uk-slideshow-item="0"><a href="#"> <img src="./socialminds/assets/images/product/product-1.jpg" alt="" class="w-16 h-12 rounded"> </a></li>
                                <li uk-slideshow-item="1"><a href="#"> <img src="./socialminds/assets/images/product/product-5.jpg" alt="" class="w-16 h-12 rounded"></a></li>
                                <li uk-slideshow-item="2"><a href="#"> <img src="./socialminds/assets/images/product/product-10.jpg" alt="" class="w-16 h-12 rounded"></a></li>
                            </ul>
                    ...
                    <div class="flex-1 space-y-8"> 
                        ...
                        <div class="md:space-y-5 space-y-3 p-5 max-md:pt-0 md:pr-2">
                            ...
                            <div>
                                ...
                                <p class="text-xs mt-2 font-light text-gray-900 dark:text-white"> Listed 2 weeks ago in Turkey</p>
                            </div>

                            <h1 class="text-2xl font-semibold"> ₹2999 </h1>
                            ...
                            <p class="text-sm text-black font-light dark:text-white">   </p>
                        ...
                        <ul class="uk-slider-items w-[calc(100%+10px)]" uk-scrollspy="target: > li; cls: uk-animation-scale-up; delay: 20;repeat:true">
                            ...
                            <li class="lg:w-1/5 md:w-1/4 sm:w-1/3 w-1/2 pr-3">
                                <div class="card uk-transition-toggle">
                                    <a href="product-view-1.php">
                                        <div class="card-media sm:aspect-[2/1.7] h-36">
                                            <img src="./socialminds/assets/images/product/product-8.jpg" alt="">
                                            <div class="card-overly"></div> 
                                        </div> 
                                    </a>
                                    <div class="card-body flex justify-between">
                                        <div class="flex-1">
                                            <a href="product-view-1.php"><p class="card-text text-black font-medium line-clamp-1"> Parfum </p> </a>
