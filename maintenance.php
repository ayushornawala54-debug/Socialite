				...
				<div class="col-xxl-5 col-lg-5 col-sm-6 col-12">
					<div class="vh-100 d-flex justify-content-center flex-column">
						<div class="text-center text-white">
							<h1 class="mb-4 display-4">We’ll be back soon!</h1>
							<h3 class="mb-5 fw-lighter lh-2">
								Sorry for the inconvenience. We’re performing some maintenance
								at the moment. We will be back online shortly!
							</h3>
							<a href="admin_feed.php" class="btn btn-warning px-5 shadow-lg py-3 fs-5">Go back to dashboard</a>
						</div>
					</div>
				</div>
			</div>
