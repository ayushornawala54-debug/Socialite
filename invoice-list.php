      ...
      <div class="app-header d-flex align-items-center">
        ...
        <div class="app-brand py-2 ms-3">
          <a href="admin_feed.php" class="d-sm-block d-none">
            <img src="./socialite-admin/assets/images/logo.svg" class="logo" alt="Bootstrap Gallery" />
          </a>
          <a href="admin_feed.php" class="d-sm-none d-block">
            <img src="./socialite-admin/assets/images/logo-sm.svg" class="logo" alt="Bootstrap Gallery" />
          </a>
        </div>
        <!-- App brand ends -->
        ...
        <div class="header-actions col">
          ...
          <div class="dropdown ms-2">
            <a id="userSettings" class="dropdown-toggle d-flex py-2 align-items-center text-decoration-none" href="#!"
              ...
              <img src="./socialite-admin/assets/images/user.png" class="rounded-2 img-3x" alt="Bootstrap Gallery" />
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="./socialite-admin/assets/images/user.png" class="img-3xx rounded-5 me-3"
                                  alt="Bootstrap Gallery" />
                                <p class="m-0">Felicia Quinn</p>
                              </div>
                            </td>
                            <td>2 Hours Ago</td>
