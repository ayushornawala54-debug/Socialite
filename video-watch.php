...
<body>
                            ...
                            <div class="mt-3 space-y-4">
                                ...
                                <div class="relative flex lg:flex-row flex-col gap-2.5">
                                    ...
                                    <div class="relative lg:w-[130px] lg:h-[80px] aspect-[3/1.5] overflow-hidden rounded-lg shrink-0">
                                        <img class="object-cover w-full h-full" src="./socialminds/assets/images/video/img-2.png" alt="">
                                        <!-- iconplay -->
                                        <img src="./socialminds/assets/images/icon-play.svg" class="w-6 h-6 absolute !top-1/2 !left-1/2 -translate-x-1/2 -translate-y-1/2" alt="">
                                        <!-- timer -->
                                ...
                                <div class="relative flex lg:flex-row flex-col gap-2.5">
                                    ...
                                    <!-- video thumbal -->
                                    <div class="relative lg:w-[130px] lg:h-[80px] aspect-[3/1.5] overflow-hidden rounded-lg shrink-0">
                                        <img class="object-cover w-full h-full" src="./socialminds/assets/images/video/img-3.png" alt="">
                                        <!-- iconplay -->
                                        <img src="./socialminds/assets/images/icon-play.svg" class="w-6 h-6 absolute !top-1/2 !left-1/2 -translate-x-1/2 -translate-y-1/2" alt="">
                                        <!-- timer -->
                                        <div class="absolute bottom-1 right-1 bg-black/70 font-normal rounded px-0.5 py-0.5 text-xs text-white"> 10:32</div>
                                ...
                                <div class="relative flex lg:flex-row flex-col gap-2.5">
                                    ...
                                    <!-- video thumbal -->
                                    <div class="relative lg:w-[130px] lg:h-[80px] aspect-[3/1.5] overflow-hidden rounded-lg shrink-0">
                                        <img class="object-cover w-full h-full" src="./socialminds/assets/images/video/img-4.png" alt="">
                                        <!-- iconplay -->
                                        <img src="./socialminds/assets/images/icon-play.svg" class="w-6 h-6 absolute !top-1/2 !left-1/2 -translate-x-1/2 -translate-y-1/2" alt="">
                                        <!-- timer -->
                                        <div class="absolute bottom-1 right-1 bg-black/70 font-normal rounded px-0.5 py-0.5 text-xs text-white"> 10:32</div>
                                ...
                                <div class="relative flex lg:flex-row flex-col gap-2.5">
                                    ...
                                    <!-- video thumbal -->
                                    <div class="relative lg:w-[130px] lg:h-[80px] aspect-[3/1.5] overflow-hidden rounded-lg shrink-0">
                                        <img class="object-cover w-full h-full" src="./socialminds/assets/images/video/img-5.png" alt="">
                                        <!-- iconplay -->
                                        <img src="./socialminds/assets/images/icon-play.svg" class="w-6 h-6 absolute !top-1/2 !left-1/2 -translate-x-1/2 -translate-y-1/2" alt="">
                                        <!-- timer -->
                                        <div class="absolute bottom-1 right-1 bg-black/70 font-normal rounded px-0.5 py-0.5 text-xs text-white"> 10:32</div>
                                ...
                                <div class="relative flex lg:flex-row flex-col gap-2.5">
                                    ...
                                    <!-- video thumbal -->
                                    <div class="relative lg:w-[130px] lg:h-[80px] aspect-[3/1.5] overflow-hidden rounded-lg shrink-0">
                                        <img class="object-cover w-full h-full" src="./socialminds/assets/images/video/img-1.png" alt="">
                                        <!-- iconplay -->
                                        <img src="./socialminds/assets/images/icon-play.svg" class="w-6 h-6 absolute !top-1/2 !left-1/2 -translate-x-1/2 -translate-y-1/2" alt="">
                                        <!-- timer -->
                                        <div class="absolute bottom-1 right-1 bg-black/70 font-normal rounded px-0.5 py-0.5 text-xs text-white"> 10:32</div>
    ...
    <!-- post preview modal --> 
    <div class="hidden lg:p-10 max-lg:!items-start lg:overflow-hidden uk-open" id="preview_modal" uk-modal="">
        
        <div class="uk-modal-dialog tt relative mx-auto overflow-hidden shadow-xl rounded-lg lg:flex items-center  w-full lg:h-[85vh]">
          
            <!-- video player --> 
            <div class="lg:h-full lg:w-[calc(100vw-400px)] w-full h-96 flex justify-center items-center relative bg-black/90 backdrop-blur">
                 
                <div class="w-full" uk-sticky="cls-active: sticked uk-animation-scale-up; media: 992; top:600">
                    <iframe src="https://www.youtube.com/embed/0fYi8SGA20k" class="w-full aspect-video" uk-video="autoplay: inview"></iframe>
                </div>
            ...
            <div class="lg:w-[400px] w-full bg-white h-full relative  overflow-y-auto shadow-xl dark:bg-dark2 flex flex-col justify-between">
                ...
                <div class="p-5 pb-0">
                    ...
                    <div class="flex gap-3 text-sm font-medium">
                        <img src="./socialminds/assets/images/avatars/avatar-5.jpg" alt="" class="w-9 h-9 rounded-full">
                        <div class="flex-1">
                ...
                <div class="p-5 h-full overflow-y-auto flex-1">
                    ...
                    <div class="relative text-sm font-medium space-y-5"> 
                        ...
                        <div class="flex items-start gap-3 relative">
                            <img src="./socialminds/assets/images/avatars/avatar-2.jpg" alt="" class="w-6 h-6 mt-1 rounded-full">
                            <div class="flex-1">
                        ...
                        <div class="flex items-start gap-3 relative">
                            <img src="./socialminds/assets/images/avatars/avatar-3.jpg" alt="" class="w-6 h-6 mt-1 rounded-full">
                            <div class="flex-1">
                        ...
                        <div class="flex items-start gap-3 relative">
                            <img src="./socialminds/assets/images/avatars/avatar-7.jpg" alt="" class="w-6 h-6 mt-1 rounded-full">
                            <div class="flex-1">
                        ...
                        <div class="flex items-start gap-3 relative">
                            <img src="./socialminds/assets/images/avatars/avatar-4.jpg" alt="" class="w-6 h-6 mt-1 rounded-full">
                            <div class="flex-1">
                        ...
                        <div class="flex items-start gap-3 relative">
                            <img src="./socialminds/assets/images/avatars/avatar-5.jpg" alt="" class="w-6 h-6 mt-1 rounded-full">
                            <div class="flex-1">
                ...
                <div class="bg-white p-3 text-sm font-medium flex items-center gap-2 dark:bg-dark2">
                                
                    <img src="./socialminds/assets/images/avatars/avatar-2.jpg" alt="" class="w-6 h-6 rounded-full">
