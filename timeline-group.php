                                ...
                                <div class="text-sm h-[400px] w-full overflow-y-auto pr-2">
                                    ...
                                    <div class="pl-2 p-1 text-sm font-normal dark:text-white">
                                        ...
                                        <a href="#" class="relative flex items-center gap-3 p-2 duration-200 rounded-xl pr-10 hover:bg-secondery dark:hover:bg-white/10 bg-teal-500/5">
                                            <div class="relative w-12 h-12 shrink-0"> <img src="./socialminds/assets/images/avatars/avatar-3.jpg" alt="" class="object-cover w-full h-full rounded-full"></div>
                                            <div class="flex-1 ">
                                        ...
                                        <a href="#" class="relative flex items-center gap-3 p-2 duration-200 rounded-xl pr-10 hover:bg-secondery dark:hover:bg-white/10">
                                            <div class="relative w-12 h-12 shrink-0"> <img src="./socialminds/assets/images/avatars/avatar-7.jpg" alt="" class="object-cover w-full h-full rounded-full"></div>
                                            <div class="flex-1 ">
                                        ...
                                        <a href="#" class="relative flex items-center gap-3 p-2 duration-200 rounded-xl pr-10 hover:bg-secondery dark:hover:bg-white/10">
                                            <div class="relative w-12 h-12 shrink-0"> <img src="./socialminds/assets/images/avatars/avatar-6.jpg" alt="" class="object-cover w-full h-full rounded-full"></div>
                                            <div class="flex-1 ">
                                        ...
                                        <a href="#" class="relative flex items-center gap-3 p-2 duration-200 rounded-xl pr-10 hover:bg-secondery dark:hover:bg-white/10">
                                            <div class="relative w-12 h-12 shrink-0"> <img src="./socialminds/assets/images/avatars/avatar-2.jpg" alt="" class="object-cover w-full h-full rounded-full"></div>
                                            <div class="flex-1 "> 
                                        ...
                                        <a href="#" class="relative flex items-center gap-3 p-2 duration-200 rounded-xl pr-10 hover:bg-secondery dark:hover:bg-white/10">
                                            <div class="relative w-12 h-12 shrink-0"> <img src="./socialminds/assets/images/avatars/avatar-4.jpg" alt="" class="object-cover w-full h-full rounded-full"></div>
                                            <div class="flex-1 ">
            ...
            <div class="max-w-[1065px] mx-auto">
                ...
                <div class="bg-white shadow lg:rounded-b-2xl lg:-mt-10 dark:bg-dark2">
                    ...
                    <div class="relative overflow-hidden w-full lg:h-72 h-36">
                        <img src="./socialminds/assets/images/group/group-cover.jpg" alt="" class="h-full w-full object-cover inset-0">
                    ...
                    <div class="lg:px-10 md:p-5 p-3">
                        ...
                        <div class="flex flex-col justify-center">
                            ...
                            <div class="flex lg:items-center justify-between max-md:flex-col">
                                ...
                                <div class="flex-1"> 
                                    <h3 class="md:text-2xl text-base font-bold text-black dark:text-white"> Friends Forever </h3>
                                ...
                                <div>
                                    <div class="flex items-center gap-2 mt-1">
                                        <div class="flex -space-x-4 mr-3">
                                            <img src="./socialminds/assets/images/avatars/avatar-2.jpg" alt="" class="w-10 rounded-full border-4 border-white dark:border-slate-800">
                                            <img src="./socialminds/assets/images/avatars/avatar-3.jpg" alt="" class="w-10 rounded-full border-4 border-white dark:border-slate-800">
                                            <img src="./socialminds/assets/images/avatars/avatar-7.jpg" alt="" class="w-10 rounded-full border-4 border-white dark:border-slate-800">
                                            <img src="./socialminds/assets/images/avatars/avatar-4.jpg" alt="" class="w-10 rounded-full border-4 border-white dark:border-slate-800">
                                            <img src="./socialminds/assets/images/avatars/avatar-5.jpg" alt="" class="w-10 rounded-full border-4 border-white dark:border-slate-800">
                                        </div>
                    ...
                    <div class="flex-1 xl:space-y-6 space-y-3">
                        ...
                        <div class="bg-white rounded-xl shadow-sm text-sm font-medium border1 dark:bg-dark2">
                            ...
                            <div class="relative w-full lg:h-96 h-full sm:px-4">
                                <img src="./socialminds/assets/images/post/img-2.jpg" alt="" class="sm:rounded-lg w-full h-full object-cover">
                            </div>
                            ...
                            <div class="sm:p-4 p-2.5 border-t border-gray-100 font-normal space-y-3 relative dark:border-slate-700/40"> 
                                ...
                                <div class="flex items-start gap-3 relative">
                                    <a href="timeline.php"> <img src="./socialminds/assets/images/avatars/avatar-2.jpg" alt="" class="w-6 h-6 mt-1 rounded-full"> </a>
                                    <div class="flex-1">
                                        <a href="timeline.php" class="text-black font-medium inline-block dark:text-white"> Steeve </a>
                                        <p class="mt-0.5">What a beautiful photo! I love it. 😍 </p>
                                    </div>
                                </div>
                                <div class="flex items-start gap-3 relative">
                                    <a href="timeline.php"> <img src="./socialminds/assets/images/avatars/avatar-3.jpg" alt="" class="w-6 h-6 mt-1 rounded-full"> </a>
                                    <div class="flex-1">
                                        <a href="timeline.php" class="text-black font-medium inline-block dark:text-white"> Monroe </a>
                            ...
                            <div class="sm:px-4 sm:py-3 p-2.5 border-t border-gray-100 flex items-center gap-1 dark:border-slate-700/40">
                                ...
                                <img src="./socialminds/assets/images/avatars/avatar-7.jpg" alt="" class="w-6 h-6 rounded-full">
                        ...
                        <div class="bg-white rounded-xl shadow-sm text-sm font-medium border1 dark:bg-dark2">
                            ...
                            <!-- post heading -->
                            <div class="flex gap-3 sm:p-4 p-2.5 text-sm font-medium">
                                <a href="timeline.php"> <img src="./socialminds/assets/images/avatars/avatar-5.jpg" alt="" class="w-9 h-9 rounded-full"> </a> 
                                <div class="flex-1">
                                    <a href="timeline.php"> <h4 class="text-black dark:text-white"> John Michael </h4> </a> 
                                    <div class="text-xs text-gray-500 dark:text-white/80"> 2 hours ago</div>
                                </div>
                            ...
                            <div class="sm:p-4 p-2.5 border-t border-gray-100 font-normal space-y-3 relative dark:border-slate-700/40"> 
                                ...
                                <div class="flex items-start gap-3 relative">
                                    <a href="timeline.php"> <img src="./socialminds/assets/images/avatars/avatar-5.jpg" alt="" class="w-6 h-6 mt-1 rounded-full"> </a>
                                    <div class="flex-1">
                                        <a href="timeline.php" class="text-black font-medium inline-block dark:text-white"> Jesse </a>
                        ...
                        <div class="lg:space-y-4 lg:pb-8 max-lg:grid sm:grid-cols-2 max-lg:gap-6" 
                            ...
                            <div class="box p-5 px-6">
                                ...
                                <ul class="text-gray-700 space-y-4 mt-2 mb-1 text-sm dark:text-white">
                                    <li> This group, it's not a group of Dr. Adan Adam, and she don't know about it , it's a group for peaple.</li>
                                    ...
                                    <li class="flex items-center gap-3"> 
                                        ...
                                        <div>  Members <span class="font-semibold text-black dark:text-white"> 3,240 People </span> </div>
                                    </li>
                            ...
                            <div class="box p-5 px-6">
                                ...
                                <div class="grid grid-cols-2 gap-1 text-center text-sm mt-4 mb-2 rounded-lg overflow-hidden">
                                    ...
                                    <div class="relative w-full aspect-[4/3]">
                                        <img src="./socialminds/assets/images/avatars/avatar-5.jpg" alt="" class="object-cover w-full h-full inset-0">
                                    </div> 
                                    <div class="relative w-full aspect-[4/3]">
                                        <img src="./socialminds/assets/images/avatars/avatar-7.jpg" alt="" class="object-cover w-full h-full inset-0">
                                    </div> 
                                    <div class="relative w-full aspect-[4/3]">
                                        <img src="./socialminds/assets/images/avatars/avatar-4.jpg" alt="" class="object-cover w-full h-full inset-0">
                                    </div> 
                                    <div class="relative w-full aspect-[4/3]">
                                        <img src="./socialminds/assets/images/avatars/avatar-6.jpg" alt="" class="object-cover w-full h-full inset-0">
                                    </div> 
                            ...
                            <div class="box p-5 px-6">
                                ...
                                <div class="side-list">
                                    ...
                                    <div class="side-list-item">
                                        <a href="timeline-group.php">
                                            <img src="./socialminds/assets/images/group/group-3.jpg" alt="" class="side-list-image rounded-md">
                                        </a>
                                        <div class="flex-1">
                                            <a href="timeline-group.php"><h4 class="side-list-title">     Abstract minimal </h4></a>
                                    ...
                                    <div class="side-list-item">
                                        <a href="timeline-group.php">
                                            <img src="./socialminds/assets/images/group/group-4.jpg" alt="" class="side-list-image rounded-md">
                                        </a>
                                        <div class="flex-1">
                                            <a href="timeline-group.php"><h4 class="side-list-title">     Delicious Foods  </h4></a>
                                    ...
                                    <div class="side-list-item">
                                        <a href="timeline-group.php">
                                            <img src="./socialminds/assets/images/group/group-5.jpg" alt="" class="side-list-image rounded-md">
                                        </a>
                                        <div class="flex-1">
                                            <a href="timeline-group.php"><h4 class="side-list-title">     Property Rent </h4></a>
                                   ...
                                   <div class="side-list-item">
                                        ...
                                        <div class="flex-1">
                                            <a href="timeline-group.php"><h4 class="side-list-title">      Graphic Design </h4></a>
    ...
    <div class="hidden lg:p-20 uk- open" id="create-status" uk-modal="">
        ...
        <div class="uk-modal-dialog tt relative overflow-hidden mx-auto bg-white shadow-xl rounded-lg md:w-[520px] w-full dark:bg-dark2">
            ...
            <div class="space-y-5 mt-3 p-2">
                <textarea class="w-full !text-black placeholder:!text-black !bg-white !border-transparent focus:!border-transparent focus:!ring-transparent !font-normal !text-xl" name="" id=""  rows="6" placeholder="What do you have in mind?"></textarea>
            </div>
