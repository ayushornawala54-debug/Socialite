<?php
session_start();
$conn = new mysqli("localhost", "root", "", "db_socialmedia"); // Replace with your DB credentials
...
if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['comment_text'], $_POST['post_id'])) {
    ...
    $sql = "INSERT INTO tbl_comment (post_id, user_id, comment_text, created_at) 
            VALUES ('$post_id', '$user_id', '$comment_text', NOW())";
    $conn->query($sql);
}

// Fetch all posts
$posts = $conn->query("SELECT * FROM tbl_post ORDER BY created_at DESC");

while ($post = $posts->fetch_assoc()) {
    $user_id = $post['user_id'];

    // Get number of comments
    $comment_count = $conn->query("SELECT COUNT(*) as total FROM tbl_comment WHERE post_id = $user_id")->fetch_assoc()['total'];

    // Get comments
    $comments = $conn->query("SELECT c.*, u.username FROM tbl_comment c JOIN tbl_register u ON c.post_id = u.id WHERE post_id = $user_id ORDER BY created_at ASC");
    ?>
...
<body>
    ...
    <div id="wrapper">
            ...
            <div class="lg:flex 2xl:gap-16 gap-12 max-w-[1065px] mx-auto"  id="js-oversized">
                ...
                <div class="max-w-[680px] mx-auto">
                        ...
                        <div class="bg-white rounded-xl shadow-sm text-sm font-medium border1 dark:bg-dark2">
                            ...
                            <!-- post heading -->
                             <div class="post-card border p-4 mb-4 bg-white rounded-lg">
        <!-- Post Header -->
        <div class="flex items-center mb-2">
            <img src="assets/images/avatars/avatar-3.jpg" class="w-9 h-9 rounded-full mr-3">
            <div>
                <strong>RAHUL</strong>
                <div class="text-xs text-gray-500"><?= date("F j, Y, g:i a", strtotime($post['created_at'])) ?></div>
            </div>
        </div>

        <!-- Post Image -->
        <div class="mb-2">
            <img src="<?= $post['filename'] ?>" class="w-full h-64 object-cover rounded-lg">
        </div>
        ...
        <div class="text-sm text-gray-500 mb-3">
            ❤️ <?= $post['likes'] ?> likes · 💬 <?= $comment_count ?> comments
        </div>

        <!-- Comment Form -->
        <form method="POST" class="mb-3">
            <input type="hidden" name="post_id" value="<?= $user_id ?>">
            <input type="text" name="comment_text" placeholder="Write a comment..." class="w-full border px-3 py-1.5 rounded">
        </form>
        ...
        <div class="comments space-y-2">
            <?php while ($comment = $comments->fetch_assoc()) { ?>
                <div class="flex items-start gap-2 text-sm">
                    <div class="font-medium"><?= htmlspecialchars($comment['username']) ?>:</div>
                    <div><?= htmlspecialchars($comment['comment']) ?></div>
                    <span class="text-xs text-gray-400 ml-auto"><?= date("g:i a", strtotime($comment['created_at'])) ?></span>
                </div>
            <?php } ?>
        </div>
    </div>
...
<?php } ?>
                            ...
                            <div class="sm:p-4 p-2.5 border-t border-gray-100 font-normal space-y-3 relative dark:border-slate-700/40"> 
                                ...
                                <div class="flex items-start gap-3 relative">
                                    <a href="timeline.php"> <img src="assets/images/avatars/avatar-2.jpg" alt="" class="w-6 h-6 mt-1 rounded-full"> </a>
                                    <div class="flex-1">
                                        <a href="timeline.php" class="text-black font-medium inline-block dark:text-white"> OM </a>
                                        <p class="mt-0.5">What a beautiful photo! I love it. 😍 </p>
                                    </div>
                                </div>
                                <div class="flex items-start gap-3 relative">
                                    <a href="timeline.php"> <img src="assets/images/avatars/avatar-3.jpg" alt="" class="w-6 h-6 mt-1 rounded-full"> </a>
                                    <div class="flex-1">
                                        <a href="timeline.php" class="text-black font-medium inline-block dark:text-white"> RAHUL </a>
                        ...
                        <div class="bg-white rounded-xl shadow-sm text-sm font-medium border1 dark:bg-dark2">
                            ...
                            <div class="flex gap-3 sm:p-4 p-2.5 text-sm font-medium">
                                <a href="timeline.php"> <img src="assets/images/avatars/avatar-3.jpg" alt="" class="w-9 h-9 rounded-full"> </a>  
                                <div class="flex-1">
                                    <a href="timeline.php"> <h4 class="text-black dark:text-white"> RAHUL </h4> </a>  
                        ...
                        <div class="bg-white rounded-xl shadow-sm text-sm font-medium border1 dark:bg-dark2">
                            ...
                            <!-- post heading -->
                            <div class="flex gap-3 sm:p-4 p-2.5 text-sm font-medium">
                                <a href="timeline.php"> <img src="assets/images/avatars/avatar-5.jpg" alt="" class="w-9 h-9 rounded-full"> </a> 
                                <div class="flex-1">
                            ...
                            <div class="sm:p-4 p-2.5 border-t border-gray-100 font-normal space-y-3 relative dark:border-slate-700/40"> 
                                ...
                                <div class="flex items-start gap-3 relative">
                                    <a href="timeline.php"> <img src="assets/images/avatars/avatar-5.jpg" alt="" class="w-6 h-6 mt-1 rounded-full"> </a>
                                    <div class="flex-1">
                ...
                <div class="p-5 h-full overflow-y-auto flex-1">
                    ...
                    <div class="relative text-sm font-medium space-y-5"> 
                        ...
                        <div class="flex items-start gap-3 relative">
                            ...
                            <div class="flex-1">
                                <a href="#" class="text-black font-medium inline-block dark:text-white"> KARTIK </a>
                        ...
                        <div class="flex items-start gap-3 relative">
                            ...
                            <div class="flex-1">
                                <a href="#" class="text-black font-medium inline-block dark:text-white"> SMITH </a>
                                <p class="mt-0.5">   You captured the moment.😎 </p>
                            </div>
                        </div>
                        <div class="flex items-start gap-3 relative">
                        ...
                        <div class="flex items-start gap-3 relative">
                            <img src="assets/images/avatars/avatar-3.jpg" alt="" class="w-6 h-6 mt-1 rounded-full">
                            <div class="flex-1">
                                <a href="#" class="text-black font-medium inline-block dark:text-white"> OM </a>
                        ...
                        <div class="flex items-start gap-3 relative">
                            <img src="assets/images/avatars/avatar-5.jpg" alt="" class="w-6 h-6 mt-1 rounded-full">
                            <div class="flex-1">
                                <a href="#" class="text-black font-medium inline-block dark:text-white"> AYUSH </a>
                        ...
                        <div class="flex items-start gap-3 relative">
                            <img src="assets/images/avatars/avatar-2.jpg" alt="" class="w-6 h-6 mt-1 rounded-full">
                            <div class="flex-1">
                                <a href="#" class="text-black font-medium inline-block dark:text-white"> RAHUL </a>
                                <p class="mt-0.5">What a beautiful, I love it. 😍 </p>
                            </div>
                        </div> 
                        <div class="flex items-start gap-3 relative">
    ...
    <div class="hidden lg:p-20" id="create-story" uk-modal="">
        ...
        <div class="uk-modal-dialog tt relative overflow-hidden mx-auto bg-white p-7 shadow-xl rounded-lg md:w-[520px] w-full dark:bg-dark2">
            ...
            <div class="space-y-5 mt-7">
                ...
                <div>  
                    <div class="w-full h-72 relative border1 rounded-lg overflow-hidden bg-[url('../images/ad_pattern.php')] bg-repeat">
    ...
    <!-- Ion icon -->
    <script type="module" src="./socialminds/../../unpkg.com/ionicons%405.5.2/dist/ionicons/ionicons.esm.js"></script>
    <script nomodule src="./socialminds/../../unpkg.com/ionicons%405.5.2/dist/ionicons/ionicons.js"></script>
