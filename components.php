...
<head>
    ...
    <style> .syntaxhighlighter .gutter, .syntaxhighlighter .toolbar { display: none !important ;} </style>
...
<body>
                                    ...
                                    <div class="mt-4" tabindex="-1" uk-slider="finite:true;sets: true">
                                        ...
                                        <div class="uk-slider-container pb-1">
                                            ...
                                            <ul class="uk-slider-items grid-small" uk-scrollspy="target: > li; cls: uk-animation-scale-up , uk-animation-slide-right-small; delay: 20 ;repeat: true">
                                                ...
                                                <li class="w-28">
                                                    <div class="p-3 px-4 rounded-lg bg-sky-100/60 text-pink-600 dark:sky-white dark:bg-dark4">
                        ...
                        <div class="relative bg-white border border-slate-200 p-1 rounded-xl shadow-sm overflow-hidden dark:border1 dark:bg-dark2">
                            ...
                            <div class="uk-switcher bg-slate-50 rounded-lg border border-gray-100 overflow-hidden mt-[60px] dark:border1 dark:bg-dark1">
                                ...
                                <div class="p-10 relative">
                                    ...
                                    <img src="./socialminds/assets/images/demos/beams.jpg" alt="" class="dark:hidden absolute top-1/2 left-1/2 max-w-none -translate-x-1/2 -translate-y-1/2 w-[1200px]">
                                ...
                                <div class="relative uk-transition-toggle">
                                    ...
                                    <div class="w-full overflow-y-auto lg:h-80 code-editor -mb-8">
                                        ...
                                        <pre id="accordion_1" class="brush: php">
                        ...
                        <div class="relative bg-white border border-slate-200 p-1 rounded-xl shadow-sm overflow-hidden dark:border1 dark:bg-dark2">
                            ...
                            <div class="uk-switcher bg-slate-50 rounded-lg border border-gray-100 overflow-hidden mt-[60px] dark:border1 dark:bg-dark1">
                                ...
                                <div class="relative uk-transition-toggle">
                                    ...
                                    <div class="absolute z-40 bottom-11 right-3 bg-white/10 text-white rounded-full uk-transition-slide-bottom-small backdrop-blur px-2.5 py-1.5 font-semibold text-sm">
                                        <div class="relative z-10 overflow-hidden ease-linear duration-500 flex items-center gap-1 group pr-1">
                                            <input onclick="selectElementContents( document.getElementById('php_1') );" type="button" class="absolute inset-0 z-10 w-full h-full cursor-pointer">
                                            <svg class="group-aria-expanded:-translate-y-6 w-5 h-5 text-white hover:text-white transition-all" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z"></path><path fill-rule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3zm-3 4a1 1 0 100 2h.01a1 1 0 100-2H7zm3 0a1 1 0 100 2h3a1 1 0 100-2h-3z" clip-rule="evenodd"></path></svg>
                                            Copy
                                        </div>
                                        <div class="!top-[5px] " uk-drop="animation: uk-animation-slide-bottom-small;mode:click"> <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z"></path><path fill-rule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm9.707 5.707a1 1 0 00-1.414-1.414L9 12.586l-1.293-1.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg> </div>
                                ...
                                <div class="p-10 relative">
                                    ...
                                    <div class="relative z-20">
                                        ...
                                        <div class="relative z-20 flex justify-center py-10">
                                            ...
                                            <div uk-lightbox="">
                                                <a  href="assets/images/demos/photo3.jpg"  
                                ...
                                <div class="p-10 relative">
                                    ...
                                    <div class="relative z-20">
                                        ...
                                        <div class="grid sm:grid-cols-2 gap-10" uk-lightbox="">
                                          <div>
                                              <a class="uk-inline" href="assets/images/demos/photo3.jpg" data-caption="Caption 1">
                                                  <img src="./socialminds/assets/images/demos/photo3.jpg" alt="" class="shadow rounded-md w-full h-full object-cover">
                                              </a>
                                          </div>
                                          <div>
                                              <a class="uk-inline" href="assets/images/demos/photo4.jpg" data-caption="Caption 2">
                                                  <img src="./socialminds/assets/images/demos/photo4.jpg" alt="" class="shadow rounded-md w-full h-full object-cover">
                                              </a>
                                          </div> 
                                        </div> 
                                    ...
                                    <div class="relative z-20 p-10 max-h-80 overflow-y-auto">
                                        ...
                                        <div    class="space-y-3 text-sm font-semibold dark:text-white"  
                                            ...
                                            <div class="flex items-center gap-3 p-4 bg-white shadow rounded-md dark:bg-slate-700">
                                                <img src="./socialminds/assets/images/avatars/avatar-1.jpg" alt="" class="w-12 h-12 rounded-full shadow">
                                            ...
                                            <div class="flex items-center gap-3 p-4 bg-white shadow rounded-md dark:bg-slate-700">
                                                <img src="./socialminds/assets/images/avatars/avatar-3.jpg" alt="" class="w-12 h-12 rounded-full shadow">
                                                <div class="flex-1"> Johm smith <span class="block text-xs font-medium dark:text-white/70"> Desinger</span></div> 
                                                <a href="#" class="px-3 py-1 text-sm bg-gray-200 rounded-full dark:bg-slate-600"> Message</a>
                                            </div>
                                            <div class="flex items-center gap-3 p-4 bg-white shadow rounded-md dark:bg-slate-700">
                                                <img src="./socialminds/assets/images/avatars/avatar-4.jpg" alt="" class="w-12 h-12 rounded-full shadow">
                                                <div class="flex-1"> Johm smith <span class="block text-xs font-medium dark:text-white/70"> Desinger</span></div> 
                                                <a href="#" class="px-3 py-1 text-sm bg-gray-200 rounded-full dark:bg-slate-600"> Message</a>
                                            </div>
                                            <div class="flex items-center gap-3 p-4 bg-white shadow rounded-md dark:bg-slate-700">
                                                <img src="./socialminds/assets/images/avatars/avatar-5.jpg" alt="" class="w-12 h-12 rounded-full shadow">
                                                <div class="flex-1"> Johm smith <span class="block text-xs font-medium dark:text-white/70"> Desinger</span></div> 
                                                <a href="#" class="px-3 py-1 text-sm bg-gray-200 rounded-full dark:bg-slate-600"> Message</a>
                                            </div>
                                            <div class="flex items-center gap-3 p-4 bg-white shadow rounded-md dark:bg-slate-700">
                                    ...
                                    <div class="relative z-20">
                                        ...
                                        <div class="relative" tabindex="0" uk-slider="finite: true; autoplay: true">
                                            ...
                                            <ul class="-ml-2 uk-slider-items grid-small">
                                                <li class="w-1/4">
                                                    <img src="./socialminds/assets/images/demos/slider1.jpg" class="rounded-md w-full h-full object-cover" alt="">
                                                </li> 
                                                <li class="w-1/4">
                                                    <img src="./socialminds/assets/images/demos/slider2.jpg" class="rounded-md w-full h-full object-cover" alt="">
                                                </li>
                                                <li class="w-1/4">
                                                    <img src="./socialminds/assets/images/demos/slider3.jpg" class="rounded-md w-full h-full object-cover" alt="">
                                                </li>
                                                <li class="w-1/4">
                                                    <img src="./socialminds/assets/images/demos/slider4.jpg" class="rounded-md w-full h-full object-cover" alt="">
                                                </li> 
                                                <li class="w-1/4">
                                                    <img src="./socialminds/assets/images/demos/slider2.jpg" class="rounded-md w-full h-full object-cover" alt="">
                                                </li>
                                        ...
                                        <div class="relative" tabindex="0" uk-slider="finite: true; autoplay: true">
                                            ...
                                            <div class="overflow-hidden uk-slider-container">
                                                ...
                                                <ul class="-ml-2 uk-slider-items w-[calc(100%+0.5rem)]">
                                                    <li class="w-1/4 pr-2">
                                                        <img src="./socialminds/assets/images/demos/photo1.jpg" class="rounded-md w-full h-full object-cover" alt="">
                                                    </li> 
                                                    <li class="w-1/4 pr-2">
                                                        <img src="./socialminds/assets/images/demos/slider2.jpg" class="rounded-md w-full h-full object-cover" alt="">
                                                    </li>
                                        ...
                                        <div class="relative uk-visible-toggle" tabindex="-1" uk-slideshow="finite: true; autoplay: true">
                                            ...
                                            <ul class="uk-slideshow-items"> 
                                                <li class="w-full overflow-hidden rounded-md">
                                                    <img src="./socialminds/assets/images/demos/photo1.jpg" alt="" uk-cover>
                                                </li>
                                                <li class="w-full overflow-hidden rounded-md">
                                                    <img src="./socialminds/assets/images/demos/photo2.jpg" alt="" uk-cover>
                                                </li>
                                                <li class="w-full overflow-hidden rounded-md">
                                                    <img src="./socialminds/assets/images/demos/photo3.jpg" alt="" uk-cover>
                                                </li>
                                            </ul>
                                ...
                                <div class="p-10 relative">
                                    ...
                                    <div class="relative z-20">
                                        ...
                                        <div class="relative" tabindex="-1" uk-slideshow="animation: push;min-height: 300; max-height: 400">
                                            ...
                                            <ul class="uk-slideshow-items"> 
                                                <li class="w-full overflow-hidden rounded-md">
                                                    <img src="./socialminds/assets/images/demos/photo1.jpg" alt="" class="rounded-md w-full h-full object-cover">
                                                </li>
                                                <li class="w-full overflow-hidden rounded-md">
                                                    <img src="./socialminds/assets/images/demos/photo2.jpg" alt="" class="rounded-md w-full h-full object-cover">
                                                </li>
                                                <li class="w-full overflow-hidden rounded-md">
                                                    <img src="./socialminds/assets/images/demos/photo3.jpg" alt="" class="rounded-md w-full h-full object-cover">
                                                </li>
                                            </ul>
	...
	==============================================-->
    <script type="text/javascript" src="./socialminds/assets/syntax-highlighter/scripts/shCore.js"></script>
    <script type="text/javascript" src="./socialminds/assets/syntax-highlighter/scripts/shBrushJScript.js"></script>
    <script type="text/javascript" src="./socialminds/assets/syntax-highlighter/scripts/shBrushXml.js"></script>
