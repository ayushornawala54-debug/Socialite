                        ...
                        <ul class="mt-2 -space-y-2" 
                            ...
                            <li class="uk-parent">
                                ...
                                <ul class="pl-10 my-1 space-y-0 text-sm">
                                    <li><a href="components.php" class="!py-2 !rounded -md">Elements</a></li>
                                    <li><a href="components.php" class="!py-2 !rounded -md">Components</a></li>
                                    <li><a href="components.php" class="!py-2 !rounded -md">Icons</a></li>
                                </ul>
                            </li>
                    ...
                    <div class="uk-slider-container pb-1">
                        ...
                        <ul class="uk-slider-items grid-small">
                            ...
                            <li class="lg:w-1/4 sm:w-1/3 w-1/2">
                                <div class="card">
                                    <a href="timeline-event.php">
                                        <div class="card-media h-32">
                                            <img src="./socialminds/assets/images/events/img-3.jpg" alt="">
                                            <div class="card-overly"></div>
                                        </div>
                                    </a>
                                    <div class="card-body">
                                        <p class="text-xs font-medium text-blue-600 mb-1"> Next week </p> 
                                        <a href="timeline-event.php"><h4 class="card-title text-sm"> About Safety and Flight  </h4> </a>
                            ...
                            <li class="lg:w-1/4 sm:w-1/3 w-1/2">
                                <div class="card">
                                    <a href="timeline-event.php">
                                        <div class="card-media h-32">
                                            <img src="./socialminds/assets/images/events/img-2.jpg" alt="">
                                            <div class="card-overly"></div>
                                        </div>
                                    </a>
                                    <div class="card-body">
                                        <p class="text-xs font-semibold text-teal-600 mb-1">Opening</p>
                                        <a href="timeline-event.php"><h4 class="card-title text-sm"> Wedding trend Ideas  </h4> </a>
                            ...
                            <li class="lg:w-1/4 sm:w-1/3 w-1/2">
                                <div class="card">
                                    <a href="timeline-event.php">
                                        <div class="card-media h-32">
                                            <img src="./socialminds/assets/images/events/img-1.jpg" alt="">
                                            <div class="card-overly"></div>
                                        </div>
                                    </a>
                                    <div class="card-body">
                                        <p class="text-xs font-medium text-red-600 mb-1"> WED JUL 10,2024 AT 10PM </p> 
                                        <a href="timeline-event.php"><h4 class="card-title text-sm"> The global creative  </h4> </a>
                            ...
                            <li class="lg:w-1/4 sm:w-1/3 w-1/2">
                                <div class="card">
                                    <a href="timeline-event.php">
                                        <div class="card-media h-32">
                                            <img src="./socialminds/assets/images/events/img-4.jpg" alt="">
                                            <div class="card-overly"></div>
                                        </div>
                                    </a>
                                    <div class="card-body">
                                        <p class="text-xs font-semibold text-teal-600 mb-1">Opening</p>
                                        <a href="timeline-event.php"><h4 class="card-title text-sm"> Perspective is everything  </h4> </a>
                    ...
                    <div class="uk-slider-container pb-1">
                        ...
                        <ul class="uk-slider-items grid-small">
                            ...
                            <li class="md:w-1/5 sm:w-1/3 w-1/2">
                                <a href="#">
                                    <div class="relative rounded-lg overflow-hidden">
                                        <img src="./socialminds/assets/images/events/listing-1.jpg" alt="" class="h-36 w-full object-cover">
                            ...
                            <li class="md:w-1/5 sm:w-1/3 w-1/2">
                                <a href="#">
                                    <div class="relative rounded-lg overflow-hidden">
                                        <img src="./socialminds/assets/images/events/listing-2.jpg" alt="" class="h-36 w-full object-cover">
                                        <div class="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-10">
                                            <div class="text-white p-5">
                           ...
                           <li class="md:w-1/5 sm:w-1/3 w-1/2">
                                <a href="#">
                                    <div class="relative rounded-lg overflow-hidden">
                                        <img src="./socialminds/assets/images/events/listing-3.jpg" alt="" class="h-36 w-full object-cover">
                                        <div class="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-10">
                                            <div class="text-white p-5">
                            ...
                            <li class="md:w-1/5 sm:w-1/3 w-1/2">
                                <a href="#">
                                    <div class="relative rounded-lg overflow-hidden">
                                        <img src="./socialminds/assets/images/events/listing-4.jpg" alt="" class="h-36 w-full object-cover">
                                        <div class="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-10">
                                            <div class="text-white p-5">
