                    ...
                    <div class="max-w-[680px] w-full mx-auto">
                        ...
                        <div class="box p-5">
                            ...
                            <div class="flex items-baseline justify-between text-black dark:text-white">
                                <h3 class="font-bold text-base"> Groups You Manage </h3>
                                    ...
                                    <ul class="-ml-2 uk-slider-items w-[calc(100%+0.5rem)] pt-3 text-center"  uk-scrollspy="target: > li; cls: uk-animation-scale-up; delay: 20 ;repeat: true">
                                            ...
                                            <a href="timeline-group.php">
                                                <div class="relative">
                                                    <div class="card-media md:aspect-[2/1.8] max-lg:h-28 rounded-lg">
                                                        <img src="./socialminds/assets/images/group/group-1.jpg" alt="">
                                                        <div class="card-overly"></div>
                                                    </div>
                                                    <h4 class="card-title text-sm pt-2 line-clamp-1">  Graphic Design</h4>
                                        ...
                                        <li class="md:w-[14.28%] w-32 pr-3 pt-3">
                                            <a href="timeline-group.php">
                                                <div class="relative">
                                                    <div class="card-media md:aspect-[2/1.8] max-lg:h-28 rounded-lg">
                                                        <img src="./socialminds/assets/images/group/group-2.jpg" alt="">
                                                        <div class="card-overly"></div>
                                                    </div>
                                                    <h4 class="card-title text-sm pt-2 line-clamp-1"> Delicious Foods  </h4>
                                                    <div class="bg-blue-600 rounded-full w-3 h-3 ring-4 ring-white absolute top-0 right-0 -m-1 z-[2]"></div> 
                                                </div>
                                            </a>
                                        </li> 
                                        <li class="md:w-[14.28%] w-32 pr-3 pt-3">
                                            <a href="timeline-group.php">
                                                <div class="relative">
                                                    <div class="card-media md:aspect-[2/1.8] max-lg:h-28 rounded-lg">
                                                        <img src="./socialminds/assets/images/group/group-3.jpg" alt="">
                                                        <div class="card-overly"></div>
                                                    </div>
                                                    <h4 class="card-title text-sm pt-2 line-clamp-1"> Abstract minimal </h4>
                                                    <div class="bg-blue-600 rounded-full w-3 h-3 ring-4 ring-white absolute top-0 right-0 -m-1 z-[2]"></div> 
                                                </div>
                                            </a> 
                                        </li> 
                                        <li class="md:w-[14.28%] w-32 pr-3 pt-3">
                                            <a href="timeline-group.php">
                                                <div class="relative">
                                                    <div class="card-media md:aspect-[2/1.8] max-lg:h-28 rounded-lg">
                                                        <img src="./socialminds/assets/images/group/group-4.jpg" alt="">
                                                        <div class="card-overly"></div>
                                                    </div>
                                                    <h4 class="card-title text-sm pt-2 line-clamp-1"> Delicious Foods  </h4>
                                                </div>
                                        ...
                                        <li class="md:w-[14.28%] w-32 pr-3 pt-3">
                                            <a href="timeline-group.php">
                                                <div class="relative">
                                                    <div class="card-media md:aspect-[2/1.8] max-lg:h-28 rounded-lg">
                                                        <img src="./socialminds/assets/images/group/group-5.jpg" alt="">
                                                        <div class="card-overly"></div>
                                                    </div>
                                                    <h4 class="card-title text-sm pt-2 line-clamp-1"> Property Rent </h4>
                                                </div>
                                            </a>
                                        </li> 
                                        <li class="md:w-[14.28%] w-32 pr-3 pt-3">
                            ...
                            <div>
                                ...
                                <div class="grid md:grid-cols-3 grid-cols-2 gap-2.5" uk-scrollspy="target: > div; cls: uk-animation-scale-up; delay: 20 ;repeat: true">
                                    ...
                                    <div class="card">
                                        <a href="timeline-group.php"> 
                                            <div class="card-media h-24">
                                                <img src="./socialminds/assets/images/group/group-cover-4.jpg" alt="">
                                                <div class="card-overly"></div>
                                            </div>
                                        </a>
                                        <div class="card-body relative z-10">
                                            <img src="./socialminds/assets/images/avatars/avatar-4.jpg" alt="" class="w-10 rounded-full mb-2 shadow md:-mt-11 -mt-7 relative border-2 border-white">
                                            <a href="timeline-group.php"> <h4 class="card-title"> Delicious Foods  </h4></a>
                                            <div class="card-text mt-1">
                                                <div class="flex items-center flex-wrap space-x-1">
                                                    <a href="timeline-group.php"> <span> 218 Members </span> </a> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card"> 
                                        <a href="timeline-group.php"> 
                                            <div class="card-media h-24">
                                                <img src="./socialminds/assets/images/group/group-cover-3.jpg" alt="">
                                                <div class="card-overly"></div>
                                            </div>
                                        </a>
                                        <div class="card-body relative z-10">
                                            <img src="./socialminds/assets/images/avatars/avatar-3.jpg" alt="" class="w-10 rounded-full mb-2 shadow md:-mt-11 -mt-7 relative border-2 border-white">
                                            <a href="timeline-group.php"> <h4 class="card-title"> Abstract minimal </h4></a>
                                            <div class="card-text mt-1">
                                                <div class="flex items-center flex-wrap space-x-1">
                                                    <a href="timeline-group.php"> <span> 218 Members </span> </a> 
                                                </div>
                                    ...
                                    <div class="card">
                                        <a href="timeline-group.php"> 
                                            <div class="card-media h-24">
                                                <img src="./socialminds/assets/images/group/group-cover-2.jpg" alt="">
                                                <div class="card-overly"></div>
                                            </div>
                                        </a>
                                        <div class="card-body relative z-10">
                                            <img src="./socialminds/assets/images/avatars/avatar-2.jpg" alt="" class="w-10 rounded-full mb-2 shadow md:-mt-11 -mt-7 relative border-2 border-white">
                                            <a href="timeline-group.php"> <h4 class="card-title"> Delicious Foods  </h4></a>
                                            <div class="card-text mt-1">
                                                <div class="flex items-center flex-wrap space-x-1">
                                                    <a href="timeline-group.php"> <span> 164 Members </span> </a> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body relative z-10">
                                            ...
                                            <div class="card-text mt-1">
                                                <div class="flex items-center flex-wrap space-x-1">
                                                    <a href="timeline-group.php"> <span> 325 Members</span> </a> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card">
                                        <a href="timeline-group.php"> 
                                            <div class="card-media h-24">
                                                <img src="./socialminds/assets/images/group/group-cover-5.jpg" alt="">
                                                <div class="card-overly"></div>
                                            </div>
                                        </a>
                                        <div class="card-body relative z-10">
                                            <img src="./socialminds/assets/images/avatars/avatar-5.jpg" alt="" class="w-10 rounded-full mb-2 shadow md:-mt-11 -mt-7 relative border-2 border-white">
                                            <a href="timeline-group.php"> <h4 class="card-title"> Property Rent </h4></a>
                                        
                                            <div class="card-text mt-1">
                                                
                                                <div class="flex items-center flex-wrap space-x-1">
                                                    <a href="timeline-group.php"> <span> 158 Members </span> </a> 
                                                </div>
                                ...
                                <div class="grid md:grid-cols-3 grid-cols-2 gap-2.5" uk-scrollspy="target: > div; cls: uk-animation-scale-up; delay: 20 ;repeat: true">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body relative z-10">
                                            ...
                                            <div class="card-text mt-1">
                                                <div class="flex items-center flex-wrap space-x-1">
                                                    <a href="#"> <span> 164 Members </span> </a> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card">
                                        ...
                                        <div class="card-body relative z-10">
                                            ...
                                            <div class="card-text mt-1">
                                                <div class="flex items-center flex-wrap space-x-1">
                                                    <a href="#"> <span> 218 Members </span> </a> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card">
                                        ...
                                        <div class="card-body relative z-10">
                                            ...
                                            <div class="card-text mt-1">
                                                <div class="flex items-center flex-wrap space-x-1">
                                                    <a href="#"> <span> 325 Members </span> </a> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card">
                                        <a href="timeline-group.php">
                                            <div class="card-media h-24">
                                                <img src="./socialminds/assets/images/group/group-cover-1.jpg" alt="">
                                                <div class="card-overly"></div>
                                            </div>
                                        </a>
                                        <div class="card-body relative z-10">
                                            <a href="timeline-group.php"> <h4 class="card-title">  Graphic Design </h4>  </a>                            
                                            <div class="card-text mt-1">
                                                <div class="flex items-center flex-wrap space-x-1">
                                                    <a href="#"> <span> 142 Members </span> </a> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="box p-5 px-6">
                            ...
                            <div class="side-list">
                                ...
                                <div class="side-list-item">
                                    <a href="timeline-group.php">
                                        <img src="./socialminds/assets/images/avatars/avatar-2.jpg" alt="" class="side-list-image rounded-md">
                                    </a>
                                    <div class="flex-1">
                                        <a href="timeline-group.php"><h4 class="side-list-title">  John Michael</h4></a>
                                ...
                                <div class="side-list-item">
                                    <a href="timeline-group.php">
                                        <img src="./socialminds/assets/images/avatars/avatar-4.jpg" alt="" class="side-list-image rounded-md"> 
                                    </a>
                                    <div class="flex-1">
                                        <a href="timeline-group.php"><h4 class="side-list-title"> Martin Gray</h4></a>
                                ...
                                <div class="side-list-item">
                                    <a href="timeline-group.php">
                                        <img src="./socialminds/assets/images/avatars/avatar-3.jpg" alt="" class="side-list-image rounded-md">
                                    </a>
                                    <div class="flex-1">
                                        <a href="timeline-group.php"><h4 class="side-list-title"> Monroe Parker</h4></a>
                                ...
                                <div class="side-list-item">
                                    <a href="timeline-group.php">
                                        <img src="./socialminds/assets/images/avatars/avatar-1.jpg" alt="" class="side-list-image rounded-md">
                                    </a>
                                    <div class="flex-1">
                                        <a href="timeline-group.php"><h4 class="side-list-title"> Jesse Steeve</h4></a>
