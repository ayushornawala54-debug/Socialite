                            ...
                            <div  class="hidden bg-white rounded-lg drop-shadow-xl dark:bg-slate-700 w-64 border2"
                                ...
                                <a href="timeline.php">
                                    <div class="p-4 py-5 flex items-center gap-4">
                                        ...
                                        <form method="POST">
											<div class="flex-1">
												<h3 name="username" class="md:text-xl text-base font-semibold text-black dark:text-white">
                                ...
                                <ul class="uk-slider-items grid-small">
                                        ...
                                        <div class="card uk-transition-toggle">
                                            <a href="timeline-page.php">
                                                <div class="card-media sm:aspect-[2/1.9] h-40">
                                                    <img src="./socialminds/assets/images/avatars/avatar-1.jpg" alt="">
                                    ...
                                    <li class="lg:w-1/4 sm:w-1/3 w-1/2">
                                        <div class="card uk-transition-toggle"> 
                                            <a href="timeline-page.php">
                                                <div class="card-media sm:aspect-[2/1.9] h-40">
                                                    <img src="./socialminds/assets/images/avatars/avatar-2.jpg" alt="">
                                                    <div class="card-overly"></div>
                                                </div>
                                            </a>
                                            <div class="card-body p-3 w-full z-10 absolute bg-gradient-to-t bottom-0 from-black/60">
                                    ...
                                    <li class="lg:w-1/4 sm:w-1/3 w-1/2">
                                        <div class="card uk-transition-toggle">
                                            <a href="timeline-page.php">
                                                <div class="card-media sm:aspect-[2/1.9] h-40">
                                                    <img src="./socialminds/assets/images/avatars/avatar-3.jpg" alt="">
                                                    <div class="card-overly"></div>
                                                </div>
                                            </a>
                                            <div class="card-body p-3 w-full z-10 absolute bg-gradient-to-t bottom-0 from-black/60">
                                    ...
                                    <li class="lg:w-1/4 sm:w-1/3 w-1/2">
                                        <div class="card uk-transition-toggle">
                                            <a href="timeline-page.php">
                                                <div class="card-media sm:aspect-[2/1.9] h-40">
                                                    <img src="./socialminds/assets/images/avatars/avatar-4.jpg" alt="">
                                                    <div class="card-overly"></div>
                                                </div>
                                            </a>
                                            <div class="card-body p-3 w-full z-10 absolute bg-gradient-to-t bottom-0 from-black/60">
                                    ...
                                    <li class="lg:w-1/4 sm:w-1/3 w-1/2">
                                        <div class="card uk-transition-toggle">
                                            <a href="timeline-page.php">
                                                <div class="card-media sm:aspect-[2/1.9] h-40">
                                                    <img src="./socialminds/assets/images/avatars/avatar-6.jpg" alt="">
                                                    <div class="card-overly"></div>
                                                </div>
                                            </a>
                                            <div class="card-body p-3 w-full z-10 absolute bg-gradient-to-t bottom-0 from-black/60">
                        ...
                        <div id="page-tabs" class="uk-switcher mt-10">
                            ...
                            <div class="grid sm:grid-cols-3 grid-cols-2 gap-3" uk-scrollspy="target: > div; cls: uk-animation-scale-up; delay: 100 ;repeat: true">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <a href="timeline-page.php"> <h4 class="card-title"> Monroe Parker </h4> </a>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <a href="timeline-page.php"> <h4 class="card-title">Martin Gray </h4> </a>
                                ...
                                <div class="card">
                                    <a href="timeline-page.php">
                                        <div class="card-media sm:aspect-[2/1.7] h-40">
                                            <img src="./socialminds/assets/images/avatars/avatar-5.jpg" alt="">
                                            <div class="card-overly"></div>
                                        </div>
                                    </a>
                                    <div class="card-body">
                                        <a href="timeline-page.php"> <h4 class="card-title"> James Lewis </h4> </a> 
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <a href="timeline-page.php"> <h4 class="card-title">Alexa stella </h4> </a>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <a href="timeline-page.php"> <h4 class="card-title"> John Michael </h4> </a> 
                            ...
                            <div class="grid sm:grid-cols-2 gap-3" uk-scrollspy="target: > div; cls: uk-animation-scale-up; delay: 100 ;repeat: true">
                                ...
                                <div class="card flex space-x-5 p-5">
                                    ...
                                    <div class="card-body flex-1 p-0">
                                        <a href="timeline-page.php"> <h4 class="card-title"> Jesse Steeve </h4> </a>
                            ...
                            <div class="grid sm:grid-cols-3 grid-cols-2 gap-3" uk-scrollspy="target: > div; cls: uk-animation-scale-up; delay: 100 ;repeat: true">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body relative z-10">
                                        <img src="./socialminds/assets/images/avatars/avatar-1.jpg" alt="" class="w-10 rounded-full sm:mb-2 mb-1 shadow -mt-8 relative border-2 border-white">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body relative z-10">
                                        <img src="./socialminds/assets/images/avatars/avatar-2.jpg" alt="" class="w-10 rounded-full sm:mb-2 mb-1 shadow -mt-8 relative border-2 border-white">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body relative z-10">
                                        <img src="./socialminds/assets/images/avatars/avatar-3.jpg" alt="" class="w-10 rounded-full sm:mb-2 mb-1 shadow -mt-8 relative border-2 border-white">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body relative z-10">
                                        <img src="./socialminds/assets/images/avatars/avatar-4.jpg" alt="" class="w-10 rounded-full sm:mb-2 mb-1 shadow -mt-8 relative border-2 border-white">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body relative z-10">
                                        <img src="./socialminds/assets/images/avatars/avatar-5.jpg" alt="" class="w-10 rounded-full sm:mb-2 mb-1 shadow -mt-8 relative border-2 border-white">
                    ...
                    <div  class="lg:space-y-6 space-y-4 lg:pb-8 max-lg:grid sm:grid-cols-2 max-lg:gap-6" 
                        ...
                        <div class="box p-5 px-6">
                            ...
                            <div class="side-list">
                                ...
                                <div class="side-list-item">
                                    <a href="timeline-group.php">
                                        <img src="./socialminds/assets/images/avatars/avatar-1.jpg" alt="" class="side-list-image rounded-full">
                                    </a>
                                    <div class="flex-1">
